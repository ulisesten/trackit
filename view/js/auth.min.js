...
null!==registrar&&registrar.addEventListener("click",function(a){a=el("username-register").value;var b=el("email-register").value,c=el("password-register").value;a&&b&&c&&auth("/mobileRegister",b,c,a)});var ingresar=el("login-button");null!==ingresar&&ingresar.addEventListener("click",function(a){a.preventDefault();a=el("email-login").value;var b=el("password-login").value;a&&b&&auth("/mobileLogin",a,b)});
